...
- [Go 1.26 新特性深度分析 - OTLP 可观测性场景](#go-126-新特性深度分析---otlp-可观测性场景)
  - [📋 目录](#-目录)
  - [1. Green Tea GC](#1-green-tea-gc)
    - [1.1 概述](#11-概述)
    - [1.2 核心改进](#12-核心改进)
    - [1.3 工作原理](#13-工作原理)
    - [1.4 OTLP 场景收益](#14-otlp-场景收益)
    - [1.5 如何禁用（不推荐）](#15-如何禁用不推荐)
    - [1.6 监控 GC 性能](#16-监控-gc-性能)
  - [2. new 表达式](#2-new-表达式)
    - [2.1 语法变化](#21-语法变化)
    - [2.2 OTLP 使用场景](#22-otlp-使用场景)
    - [2.3 性能考虑](#23-性能考虑)
  - [3. 泛型自引用](#3-泛型自引用)
    - [3.1 问题背景](#31-问题背景)
    - [3.2 OTLP 使用场景](#32-otlp-使用场景)
  - [4. errors.AsType](#4-errorsastype)
    - [4.1 新函数签名](#41-新函数签名)
    - [4.2 与 errors.As 对比](#42-与-errorsas-对比)
    - [4.3 OTLP 错误处理](#43-otlp-错误处理)
  - [5. io.ReadAll 优化](#5-ioreadall-优化)
    - [5.1 性能提升](#51-性能提升)
    - [5.2 实现改进](#52-实现改进)
    - [5.3 OTLP 场景](#53-otlp-场景)
  - [6. bytes.Buffer.Peek](#6-bytesbufferpeek)
    - [6.1 新 API](#61-新-api)
    - [6.2 OTLP 协议嗅探](#62-otlp-协议嗅探)
  - [7. Goroutine Leak Profile](#7-goroutine-leak-profile)
    - [7.1 启用方式](#71-启用方式)
    - [7.2 使用方式](#72-使用方式)
    - [7.3 OTLP 泄漏场景检测](#73-otlp-泄漏场景检测)
  - [8. cgo 优化](#8-cgo-优化)
    - [8.1 性能提升](#81-性能提升)
    - [8.2 OTLP 应用场景](#82-otlp-应用场景)
  - [9. crypto/hpke](#9-cryptohpke)
    - [9.1 概述](#91-概述)
    - [9.2 OTLP 安全场景](#92-otlp-安全场景)
  - [10. 实验性特性](#10-实验性特性)
    - [10.1 simd/archsimd](#101-simdarchsimd)
    - [10.2 runtime/secret](#102-runtimesecret)
  - [📊 性能基准对比](#-性能基准对比)
    - [Green Tea GC 测试](#green-tea-gc-测试)
    - [io.ReadAll 测试](#ioreadall-测试)
  - [🎯 迁移建议](#-迁移建议)
    - [立即使用（低风险）](#立即使用低风险)
    - [逐步采用（中风险）](#逐步采用中风险)
    - [评估后使用（高风险/实验性）](#评估后使用高风险实验性)
  - [📚 参考](#-参考)
